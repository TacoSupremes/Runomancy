				 ...
				 if(is.isItemEnchanted()){
					 ...
					 if(EnchantmentHelper.getFortuneModifier(player) > 0){
						 ...
						 NBTTagList nl = is.getEnchantmentTagList();
							...
							nbt.setShort("lvl", (short)(3 + EnchantmentHelper.getFortuneModifier(player)));
					 ...
					 for (int i = 0; i < nl.tagCount(); ++i)
			            {
			                ...
			                if(j == Enchantment.fortune.effectId){
			                	nl.getCompoundTagAt(i).setShort("lvl", (short)(EnchantmentHelper.getFortuneModifier(player) - 3));
			                	break;
			                }
