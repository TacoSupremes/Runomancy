...
public class BlockPowerTorch extends BlockModContainer{
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		...
		return new TilePowerTorch();
	}

	@Override
	protected Class<? extends TileEntity> tile() {
		
		return TilePowerTorch.class;
	}
	 ...
	 public AxisAlignedBB getCollisionBoundingBox(World worldIn, BlockPos pos, IBlockState state)
	    ...
	    public void randomDisplayTick(World worldIn, BlockPos pos, IBlockState state, Random rand)
	    {
	        ...
	        if (enumfacing.getAxis().isHorizontal())
	        {
	            ...
	            worldIn.spawnParticle(EnumParticleTypes.SPELL_WITCH, d0 + d4 * (double)enumfacing1.getFrontOffsetX(), d1 + d3, d2 + d4 * (double)enumfacing1.getFrontOffsetZ(), 0.0D, 0.0D, 0.0D, new int[0]);
	        }
	        else
	        {
	            worldIn.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, d0, d1, d2, 0.0D, 0.0D, 0.0D, new int[0]);
	            worldIn.spawnParticle(EnumParticleTypes.SPELL_WITCH, d0, d1, d2, 0.0D, 0.0D, 0.0D, new int[0]);
	        }
	    }
